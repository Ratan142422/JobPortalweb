...
$jobs = [
    ...
    [
        ...
        'skills' => 'Node.js, Python, MongoDB, API',
    ...
    [
        ...
        'description' => 'Create amazing user experiences and interfaces for our digital products.',
        'posted' => '3 days ago'
    ],
    [
        'id' => 4,
        ...
        'skills' => 'MERN Stack, PostgreSQL, AWS',
        'description' => 'Work on exciting projects using modern web technologies in a startup environment.',
        'posted' => '1 week ago'
    ],
    [
        'id' => 5,
    ...
    [
        ...
        'description' => 'Drive digital marketing campaigns and optimize online presence.',
        'posted' => '2 days ago'
    ]
];

// New job database for Jobs page
$new_jobs = [
    [
        'id' => 101,
    ...
    [
        ...
        'description' => 'Conduct research and develop AI models for cutting-edge applications.',
        'posted' => '3 days ago'
    ],
    [
        'id' => 103,
    ...
    [
        ...
        'skills' => 'Agile, Scrum, Product Lifecycle, Communication',
        'description' => 'Lead product development teams to deliver innovative solutions.',
        'posted' => '5 days ago'
    ],
    [
        'id' => 105,
    ...
    [
        ...
        'description' => 'Provide technical support and resolve client issues.',
        'posted' => '3 days ago'
    ],
    [
        'id' => 108,
    ...
    [
        ...
        'description' => 'Design and maintain corporate network infrastructure.',
        'posted' => '4 days ago'
    ],
    [
        'id' => 110,
    ...
    [
        ...
        'description' => 'Build and maintain cloud infrastructure and automation pipelines.',
        'posted' => '2 days ago'
    ],
    [
        'id' => 112,
    ...
    [
        ...
        'description' => 'Design and deploy machine learning models for various applications.',
        'posted' => '3 days ago'
    ],
    [
        'id' => 114,
        ...
        'description' => 'Manage IT projects and coordinate between teams and stakeholders.',
        'posted' => '4 days ago'
    ],
    [
        'id' => 115,
        ...
        'type' => 'Full-time',
        'experience' => '3-5 years',
        'skills' => 'Requirements Gathering, Documentation, Stakeholder Management',
...
if ($_GET) {
    ...
    if (!empty($search_query) || !empty($location_filter) || !empty($type_filter)) {
        ...
        $filtered_new_jobs = array_filter($new_jobs, function($job) use ($search_query, $location_filter, $type_filter) {
            $title_match = empty($search_query) || strpos(strtolower($job['title']), $search_query) !== false;
            $skills_match = empty($search_query) || strpos(strtolower($job['skills']), $search_query) !== false;
            $company_match = empty($search_query) || strpos(strtolower($job['company']), $search_query) !== false;
            $search_match = $title_match || $skills_match || $company_match;
...
$total_new_jobs = isset($filtered_new_jobs) ? count($filtered_new_jobs) : 0;
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <main>
        ...
        <div class="jobs-container jobs-grid" id="jobsContainer">
            <?php if (empty($filtered_jobs) && empty($filtered_new_jobs)): ?>
                <div class="no-results">
                    <i class="fas fa-search"></i>
                    <h2>No such jobs available</h2>
                    <p>Try adjusting your search criteria</p>
                </div>
            <?php elseif (empty($filtered_jobs)): ?>
                <div class="no-results">
                    <i class="fas fa-search"></i>
                    <h2>No jobs found on Home Page</h2>
                    <p>Try adjusting your search criteria</p>
                </div>
            <?php else: ?>
        ...
        <div id="jobsSection" style="display:none;">
            <div class="container">
                ...
                <?php if (empty($filtered_new_jobs)): ?>
                    <div class="no-results">
                        <i class="fas fa-search"></i>
            ...
            <?php else: ?>
                <?php foreach ($filtered_new_jobs as $job): ?>
                    <div class="job-card">
                        <div class="job-header">
                            <div>
                                <h3 class="job-title"><?php echo htmlspecialchars($job['title']); ?></h3>
    ...
    <script>
        ...
        // Show jobs section automatically if search query matches jobs in jobs page
        window.addEventListener('DOMContentLoaded', function() {
            const urlParams = new URLSearchParams(window.location.search);
            const searchQuery = urlParams.get('search');
            if (searchQuery && searchQuery.trim() !== '') {
                // Check if there are any jobs in jobsSection matching the search
                const jobsSection = document.getElementById('jobsSection');
                const homeSection = document.getElementById('homeSection');
                const filteredNewJobs = <?php echo json_encode(array_values($filtered_new_jobs)); ?>;
                if (filteredNewJobs.length > 0) {
                    // Show jobs section and hide home section
